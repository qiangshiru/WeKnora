...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/knowledge-bases/{id}/knowledge/pre-chunked": {
            "post": {
                "security": [
                    {
                        "Bearer": []
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_Tencent_WeKnora_internal_types.PreChunkedKnowledgePayload"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "幂等命中已有记录",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
    ...
    "definitions": {
        ...
        "github_com_Tencent_WeKnora_internal_types.JSONMap": {
            "type": "object",
            "additionalProperties": {}
        },
        ...
        "github_com_Tencent_WeKnora_internal_types.PreChunkedChunk": {
            "type": "object",
            "properties": {
                "chunk_index": {
                    "type": "integer"
        ...
        "github_com_Tencent_WeKnora_internal_types.PreChunkedKnowledgePayload": {
            "type": "object",
            "properties": {
                "channel": {
                    "type": "string"
                ...
                "chunks": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_Tencent_WeKnora_internal_types.PreChunkedChunk"
                    }
                },
                "custom_metadata": {
                    "type": "object",
        ...
        "github_com_Tencent_WeKnora_internal_types.SearchParams": {
            ...
            "properties": {
                "chunk_ids": {
                    "description": "ChunkIDs limits retrieval to embeddings whose chunk_id is in this allowlist.\nAn empty list disables chunk ID filtering.",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
                ...
                "chunk_metadata_filter": {
                    "description": "ChunkMetadataFilter requires chunks.metadata to contain every supplied\nkey/value pair. An empty object means no metadata filtering. This is\ncurrently supported by the Postgres retriever only.",
                    "allOf": [
                        {
                            "$ref": "#/definitions/github_com_Tencent_WeKnora_internal_types.JSONMap"
                        }
                    ]
                },
